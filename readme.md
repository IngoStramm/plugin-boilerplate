...
- Plugin Boilerplate (Nome do plugin)
- plugin-boilerplate (nome dos arquivos, nome do text domain e slug da url do repositório)
- PB_ (prefixo usado nas constantes de Url e diretório do plugin, além das classes)
- pb_ (prefixo usado nas funções)
...
- [WP Update Server](https://github.com/YahnisElsts/wp-update-server): API que verifica e aplica atualizações do Plugin Boilerplate, através do próprio sistema de atualizações do WordPress
