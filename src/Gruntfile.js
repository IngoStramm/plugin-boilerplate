...
module.exports = function (grunt) {
    ...
    var moradaIdealConfig = {
        ...
        jshint: {
            ...
            all: [
                'Gruntfile.js',
                '<%= dirs.js %>/plugin-boilerplate.js',
                '<%= dirs.js %>/plugin-boilerplate-admin.js'
            ]
        },
        ...
        uglify: {
            dist: {
                files: {
                    '<%= dirs.js %>/plugin-boilerplate.min.js': [
                        '<%= dirs.js %>/plugin-boilerplate.js'    // Custom JavaScript
                    ],
                    '<%= dirs.js %>/plugin-boilerplate-admin.min.js': [
                        '<%= dirs.js %>/plugin-boilerplate-admin.js'    // Custom JavaScript
                    ]
                }
            }
        },
